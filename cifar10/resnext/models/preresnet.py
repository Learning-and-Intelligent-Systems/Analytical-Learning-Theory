...
def preactresnet34(num_classes=10, dropout = False):
    return PreActResNet(PreActBlock, [3,4,6,3], num_classes, dropout)

def preactresnet50(num_classes=10, dropout = False):
    return PreActResNet(PreActBottleneck, [3,4,6,3], num_classes, dropout)

def preactresnet101(num_classes=10, dropout = False):
    return PreActResNet(PreActBottleneck, [3,4,23,3], num_classes, dropout)

def preactresnet152(num_classes=10, dropout = False):
